...
def generate_video(self, video_id: str, user_id: str, config: Dict[str, Any]):
    ...
    try:
        ...
        total_cost = calculate_video_cost.apply_async(args=[video_id, user_id]).get()

        logger.info(
            f"Video generation completed for video_id: {video_id}, cost: ${total_cost}"
        )
...
def generate_script(video_id: str, topic: str, style: str) -> Dict[str, Any]:
    ...
    try:
        ...
        return {"script": script, "prompts": prompts, "cost": cost}
    except Exception as e:
...
def generate_visuals(video_id: str, prompts: list) -> Dict[str, Any]:
    ...
    try:
        ...
        return {"visuals": visuals, "count": len(visuals), "cost": cost}
    except Exception as e:
...
def generate_thumbnail(video_id: str, title: str) -> Dict[str, Any]:
    ...
    try:
        ...
        return {"thumbnail_path": thumbnail_path, "cost": cost}
    except Exception as e:
