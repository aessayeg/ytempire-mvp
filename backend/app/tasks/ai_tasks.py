...
class AITask(Task):
    ...
    def ai_service(self):
        if self._ai_service is None:
            ...
            self._ai_service = OpenAIService({'openai_api_key': settings.OPENAI_API_KEY})
...
def generate_thumbnail(
    ...
    try:
        ...
        result = asyncio.run(
            self.thumbnail_service.generate(
                title=title,
                style=style
            )
        )
