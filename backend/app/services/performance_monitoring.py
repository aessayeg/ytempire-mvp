...
class PerformanceMonitoringService:
    ...
    async def analyze_performance_trends(
        self, metric_type: str = "latency", time_range: int = 86400  # 24 hours
    ) -> Dict[str, Any]:
    ...
    async def _get_metric_history(
        self, metric_type: str, time_range: int
    ) -> List[Dict[str, Any]]:
