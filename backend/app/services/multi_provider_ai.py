...
class MultiProviderAIService:
    ...
    def _setup_cost_thresholds(self):
        ...
        self.cost_thresholds = {
            ...
            AIProvider.STABILITY: {ServiceType.IMAGE_GENERATION: 0.01},  # per image
            AIProvider.GOOGLE: {
    ...
    async def generate_text(
        ...
        request = AIRequest(
            ...
            provider=provider
            or self._get_optimal_provider(ServiceType.TEXT_GENERATION),
            input_text=prompt,
    ...
    async def synthesize_speech(
        ...
        request = AIRequest(
            ...
            input_text=text,
            parameters={"voice": voice, "language": language},
            user_id=user_id or "unknown",
        )
    ...
    async def generate_image(
        ...
        request = AIRequest(
            ...
            provider=provider
            or self._get_optimal_provider(ServiceType.IMAGE_GENERATION),
            input_text=prompt,
