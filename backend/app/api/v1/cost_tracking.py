...
async def get_daily_cost_summary(
    ...
    try:
        ...
        return {
            ...
            "per_video_cost": float(metrics.per_video_cost) if metrics.per_video_cost else None,
...
async def get_cost_trends(
    ...
    try:
        ...
        if len(costs_list) > 1:
            ...
            change_pct = ((costs_list[-1] - costs_list[0]) / costs_list[0] * 100) if costs_list[0] > 0 else 0
        else:
