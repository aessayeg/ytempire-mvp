...
celery_app.conf.update(
    ...
    task_queues=(
        ...
        Queue("pipeline_orchestration", Exchange("pipeline"), routing_key="pipeline.orchestrate",
              queue_arguments={"x-max-priority": 10, "x-max-length": 200}),
        Queue("batch_processing", Exchange("batch"), routing_key="batch.process",
...
def monitor_queue_depth():
    ...
    for queue_name in ["video_processing", "ai_generation", "youtube_upload", "batch_processing"]:
