...
class InvalidTokenException(AuthenticationException):
    ...
    def __init__(self):
        super().__init__(
            message="Invalid or expired token", details={"error": "token_invalid"}
        )
...
class InsufficientPermissionsException(APIException):
    ...
    def __init__(self, resource: Optional[str] = None):
        message = (
            f"Insufficient permissions to access {resource}"
            if resource
...
class PaymentRequiredException(APIException):
    ...
    def __init__(
        self,
        message: str = "Payment required to continue",
...
class YouTubeAPIException(ExternalServiceException):
    ...
    def __init__(self, message: str, quota_used: Optional[int] = None):
        ...
        super().__init__(service="YouTube", message=message, details=details)
...
class VideoProcessingException(YTEmpireException):
    ...
    def __init__(
        self, message: str, video_id: Optional[str] = None, stage: Optional[str] = None
    ):
        super().__init__(
            message=message,
