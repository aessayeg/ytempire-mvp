...
const mockViewsData = [ { date: 'Mon', views: 12000, engagement: 850 },
...
const mockCostData = [ { name: 'Script Generation', value: 35, color: '#8884d8' },
  ...
  { name: 'Infrastructure', value: 5, color: '#8 dd1 e1' } ];

const mockRevenueData = [ { month: 'Jan', revenue: 4500, costs: 1200 },
...
export const Dashboard: React.FC = () => {
  ...
  const [metrics, setMetrics] = useState<DashboardMetrics>({ totalVideos: 156,
    totalViews: 2450000,
    totalRevenue: 9800,
    totalCosts: 2200,
    activeChannels: 5,
  ...
  useEffect(() => {
    // Fetch initial data
    handleRefresh()}, []); // eslint-disable-line react-hooks/exhaustive-deps // eslint-disable-line react-hooks/exhaustive-deps
