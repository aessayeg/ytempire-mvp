...
export const CostTracking: React.FC = () => {
  ...
  const [metrics] = useState<CostMetrics>({
    totalSpent: 6590,
    monthlyBudget: 8700,
    projectedSpend: 7850,
    costPerVideo: 42.25,
                ...
                <PieChart>
                  <Pie
                    data={mockCostCategories.map(cat => ({
                      ...
                      color: ['#8884d8', '#82ca9d', '#ffc658', '#ff7c7c', '#8dd1e1'][cat.id - 1]
                    }))}
                    cx="50%"
                    cy="50%"
                    labelLine={false}
                    ...
                    dataKey="value"
                  >
                    {mockCostCategories.map((_, index) => (
                    ...
                    <Card variant="outlined" sx={{ height: '100%' }}>
                      <CardContent>
                        ...
                        <LinearProgress
                          ...
                          color={getBudgetColor(category.usage) as any}
