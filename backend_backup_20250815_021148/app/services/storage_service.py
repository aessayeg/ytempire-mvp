...
class StorageService:
    ...
    def __init__(self, base_path: str = "./uploads"):
        ...
        for path in [self.avatars_path, self.videos_path, self.thumbnails_path, self.temp_path]:
    ...
    async def save_avatar(self, file: BinaryIO, user_id: str) -> str:
        ...
        try:
            ...
            file_extension = self._get_file_extension(file.filename if hasattr(file, 'filename') else 'avatar.jpg')
    ...
    async def save_video(self, file: BinaryIO, video_id: str) -> str:
        ...
        """
        try:
            file_extension = self._get_file_extension(file.filename if hasattr(file, 'filename') else 'video.mp4')
    ...
    async def save_thumbnail(self, file: BinaryIO, video_id: str) -> str:
        ...
        """
        try:
            file_extension = self._get_file_extension(file.filename if hasattr(file, 'filename') else 'thumb.jpg')
