...
class YouTubeOAuthService:
    ...
    def load_accounts(self):
        ...
        try:
            with open(self.accounts_file, 'r') as f:
                ...
                self.accounts = {acc['account_id']: acc for acc in self.accounts_config['accounts']}
    ...
    def get_auth_url(self, account_id: str, client_secrets_file: Optional[str] = None) -> str:
        """
        ...
        try:
            ...
            secrets_file = client_secrets_file or os.environ.get('GOOGLE_CLIENT_SECRETS_FILE')
    ...
    def handle_callback(self, account_id: str, authorization_code: str) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            # Create OAuth flow
            secrets_file = os.environ.get('GOOGLE_CLIENT_SECRETS_FILE') or self._create_temp_secrets_file()
            flow = Flow.from_client_secrets_file(
                secrets_file,
                scopes=self.SCOPES,
                redirect_uri=self.redirect_uri
            ...
            account['token_expiry'] = (datetime.utcnow() + timedelta(seconds=credentials.expiry)).isoformat() if credentials.expiry else None
            ...
            if channel_response.get('items'):
                ...
                account['subscriber_count'] = int(channel['statistics'].get('subscriberCount', 0))
        ...
        try:
            ...
            if not credentials.valid:
                if credentials.expired and credentials.refresh_token:
                    ...
                    account['access_token'] = credentials.token
                    account['token_expiry'] = (datetime.utcnow() + timedelta(seconds=3600)).isoformat()
                    self.save_accounts()
