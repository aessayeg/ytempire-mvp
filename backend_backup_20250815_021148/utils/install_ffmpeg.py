...
def download_ffmpeg():
    ...
    try:
        ...
        extracted_folders = [f for f in ffmpeg_dir.iterdir() if f.is_dir() and 'ffmpeg' in f.name.lower()]
    ...
    if video_processor_path.exists():
        ...
        if "ffmpeg/ffmpeg.exe" in content:
            ...
            if old_paths in content:
                ...
                print("   [INFO] VideoProcessor code structure different, manual update may be needed")
    else:
