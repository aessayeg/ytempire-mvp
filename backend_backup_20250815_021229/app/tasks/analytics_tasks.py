            ...
            async with AsyncSessionLocal() as db:
                ...
                for channel in channels:
                    ...
                    try:
                        ...
                        analytics_data = await self.youtube_service.get_channel_analytics(
                        ...
                        for video in videos.scalars():
                            video_analytics = await self.youtube_service.get_video_analytics(
                            ...
                            analytics = Analytics(
                                ...
                                revenue=Decimal(str(video_analytics.get('revenue', 0.0))),
...
def generate_analytics_report(
    ...
    try:
        ...
        report_data = asyncio.run(
            generate_report_data(user_id, report_type)
        )
...
# Cleanup task
@celery_app.task(
    name='analytics.cleanup_old_data',
    queue='analytics'
)
